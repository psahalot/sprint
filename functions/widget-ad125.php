...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: IdeaBox 125x125 Ad Widget
...
// load widget
add_action( 'widgets_init', 'sprint_ads_widgets' );

// Register widget
function sprint_ads_widgets() {
	register_widget( 'sprint_Ad_Widget' );
}

// Widget class
class sprint_ad_widget extends WP_Widget {
...
function sprint_Ad_Widget() {

	// Widget settings
	$widget_ops = array (
		'classname' => 'sprint_ad_widget',
		'description' => __('A widget for 125 x 125 ad unit (max 6 ads)', 'sprint')
	);
	...
	$control_ops = array (
		'width' => 300,
		'height' => 350,
		'id_base' => 'sprint_ad_widget'
	);

	// Create the widget
	$this->WP_Widget( 'sprint_ad_widget', __('IdeaBox: 125x125 Ads', 'sprint'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_template_directory_uri()."/assets/images/125x125.gif",
		'link1' => 'http://ideaboxthemes.com/',
		'ad2' => get_template_directory_uri()."/assets/images/125x125.gif",
		'link2' => 'http://ideaboxthemes.com/',
		'ad3' => '',
		'link3' => '',
		'ad4' => '',
		'link4' => '',
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'sprint') ?></label>
		<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
	</p>

	<!-- Ad 1 image url: Text Input -->
	<p>
		<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Ad 5 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Ad 5 link url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Ad 6 image url:', 'sprint') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Ad 6 link url:', 'sprint') ?></label>
	...
	<!-- Randomize? -->
	<p>
		<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('Randomize ads order?', 'sprint') ?></label>
