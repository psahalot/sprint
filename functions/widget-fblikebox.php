...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: IdeaBox Facebook Like Box
...
class Facebook_Like_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'facebook_like', 'description' => __('Add Facebook Like Box.','sprint'));

		$control_ops = array('id_base' => 'facebook-like-widget');

		$this->WP_Widget('facebook-like-widget', __('IdeaBox: FB Like Box','sprint'), $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => __('Find us on Facebook','sprint'), 'page_url' => '', 'width' => '300', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
		...
		<p>
			<label for="<?php echo $this->get_field_id('page_url'); ?>"><?php _e('Facebook Page URL','sprint'); ?>:</label>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('color_scheme'); ?>" name="<?php echo $this->get_field_name('color_scheme'); ?>" style="width:100%;">
				<option <?php if ('light' == $instance['color_scheme']) echo 'selected="selected"'; ?>><?php _e('light','sprint'); ?></option>
				<option <?php if ('dark' == $instance['color_scheme']) echo 'selected="selected"'; ?>><?php _e('dark','sprint'); ?></option>
			</select>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show faces','sprint'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_stream'); ?>"><?php _e('Show stream','sprint'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_header'); ?>"><?php _e('Show facebook header','sprint'); ?></label>
		</p>
	<?php
	}
}
